    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Ayak No Sorgu</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="/panel">SorguPro</a></li>
                        <li class="breadcrumb-item active">Ayak No Sorgu</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Ayak No Sorgu</h4>
                </div><!-- end card header -->
...
<script>
   function kontrolEt() {
    ...
    if (Object.keys(data).length > 0) {
        ...
        let ayakno = res.data.ayakno || "Bulunamadı";
