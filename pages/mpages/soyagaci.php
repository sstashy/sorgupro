    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Soy Ağacı Sorgu</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="https://makima.69.mu/discord">MakimaPanel</a></li>
                        <li class="breadcrumb-item active">Soy Ağacı Sorgu</li>
                    </ol>
                </div>
            </div>
        </div>
